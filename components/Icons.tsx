...
// Fix: Added ChevronDownIcon for use in collapsible sections.
...
// Fix: Added ChevronUpIcon for use in collapsible sections.
...
// Feat: Added SparklesIcon for AI generation button
