...
const UserForm: React.FC<{
    onSubmit: (user: Omit<ManagedUser, 'id' | 'created_at'> & { password?: string }) => Promise<void>;
    onClose: () => void;
    isCreating: boolean;
...
const UserManager: React.FC<UserManagerProps> = ({ users, setUsers }) => {
    ...
    const handleCreateUser = async (userData: Omit<ManagedUser, 'id' | 'created_at'> & { password?: string }) => {
        setIsCreating(true);
        try {
